                          ...
                          <div class="row">
                              <div class="col-md-6">
                                  ...
                                  <div class="input-group">
                                      <span class="input-group-text"><i class="bi-book"></i></span>
                              ...
                              <div class="col-md-6">
                                  <label for="descripcion" class="form-label">Descripción <sup
                                          class="text-danger">(*)</sup></label>
                                  <div class="input-group">
                                      <span class="input-group-text"><i class="bi-file-earmark-text"></i></span>
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-6">
                                  <label for="direccion" class="form-label">Dirección <sup
                                          class="text-danger">(*)</sup></label>
                                  <div class="input-group">
                                      <span class="input-group-text"><i class="bi-info-circle"></i></span>
                                      ...
                                      <select name="divisa" id="" class="form-control">
                                          ...
                                          @foreach ($data as $item)
                                              <option value="{{ $item['symbol'] }}"
                                                  {{ old('data', $ajuste?->data) == $item['symbol'] ? 'selected' : '' }}>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (alertElement) {
            ...
            setTimeout(function () {
                // Opción A: Usando la API de Bootstrap (para que se desvanezca bonito)
                // Asegúrate de que 'bootstrap' esté disponible globalmente
                if (typeof bootstrap !== 'undefined') {
                    var alertInstance = new bootstrap.Alert(alertElement);
                    alertInstance.close();
                } else {
                    // Opción B: Eliminación forzada (si Bootstrap JS no responde)
                    alertElement.remove();
                }
            }, 3000); // <-- Puedes cambiar el tiempo aquí
        }
    });
</script>
</div>
