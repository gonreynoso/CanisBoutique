...
@section('content')
    <h1 class="text-2xl font-bold mb-2">Datos registrados del rol: {{ $role->name }}</h1>
    <hr class="mb-2">
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" name="name" class="form-control" id="name"
                                        placeholder="Nombre del rol" value="{{ $role->name }}" readonly>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" name="name" class="form-control" id="name"
                                            placeholder="Fecha y hora de creación" value="{{ $role->created_at }}" readonly>
