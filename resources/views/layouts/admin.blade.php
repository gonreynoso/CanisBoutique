...
<head>
  ...
  @vite([
    // Frontend principal de Tailwind (si lo usas aquí)
    'resources/css/app.css',
    'resources/js/app.js',

    // Archivos específicos de la plantilla Mazer
    'resources/css/admin.css', // Tu CSS copiado/modificado
    'resources/js/admin.js',   // Tu JS copiado/modificado
  ])
</head>
...
<body>
      ...
      <footer>
        <div class="footer clearfix mb-0 text-muted">
          <div class="float-start">
            <p>2025 &copy; CanisBoutique</p>
          </div>
          <div class="float-end">
            <p>Realizado por <span class="text-danger"><i class="bi bi-heart-fill icon-mid"></i></span>
  ...
  <script src="{{ asset('mazer-assets/assets/extensions/apexcharts/apexcharts.min.js') }}"></script>
  <script src="{{ asset('mazer-assets/assets/static/js/pages/dashboard.js') }}"></script>
